...
export const Menu = () => {
  ...
  return (
    ...
    <div className='menu-container'>
      ...
      <div className='entradas-container'><h1>Entradas</h1>
        ...
        <h2>Carpaccio Filete</h2>
        <h3>Carpaccio de filete de res</h3>

        <h2>Carpaccio Salmón</h2>
        <h3>Carpaccio de Salmón</h3>

        <h2>Gambas fritas y salsa Livornesa</h2>
        <h3></h3>

        <h2>Gamberi pil-pil</h2>
        <h3>Camarones al pil-pil</h3>

        <h2>Belvedere</h2>
        <h3>Mariscos en hojas de espinaca, salsa aioli</h3>

        <h2>Caprese di sempre</h2>
    ...
    <h3>Con tomate italiano natural y albahaca.</h3>

    <h2>SPAGHETTI NAPOLITANA</h2>
    <h3>CON SALSA DE TOMATES ARTESANAL LE DUE TORRI</h3>

    <h2>SPAGHETTI AL PESTO</h2>
    <h3>SPAGHETTI CON PESTO NATURAL ARTESANAL</h3>

    <h2>SPAGHETTI PUTTANESCA</h2>
    <h3>TOMATE ITALIANO, ANCHOAS, ALCAPARRAS, ACEITUNAS, UN LEVE TOQUE DE CACHO DE CABRA</h3>
  ...
  <h3>LOMO A LA PARRILLA</h3>

<h2>FILETE PAILLARD A LA PARRILLA</h2>
<h3>Filete achurrascado con un poco de ajo y romero.</h3>

<h2>ESCALOPINES AL VINO BLANCO</h2>
<h3>EXQUISITOS ESCALOPINES AL VINO BLANCO
</h3>

<h2>ESCALOPINES AL MARSALA</h2>
<h3>Suaves y tiernos cocinados lentamente y terminados en un maravilloso marsala italiano.</h3>

<h2>LOMO VETADO EN SALSA FUNGHI</h2>
<h3>LOMO SALSA FUNGHI</h3>
...
<div className='pescados-container' >
  ...
  <h2>MERLUZA AUSTRAL A LA PARRILLA</h2>

  <h2>ALLA GENOVESE</h2>
  <h3>Salmon, Merluza Austral o Reineta Con salsa de tomate cherry, orégano, aceitunas y alcaparra.</h3>
